...
public class Pixel implements Comparable<Pixel> {
    ...
    public Pixel(int r, int g, int b) {
        ...
        // red loop to check for out of bounds value
        if (r < 0) {
            r = 0;
        ...
        // green loop to check for out of bounds value
        if (g < 0) {
            g = 0;
        ...
        // blue loop to check for out of bounds value
        if (b < 0) {
            b = 0;
        ...
        // set each part of the array to red, green, or blue, respectively
        col[0] = r;
        col[1] = g;
        col[2] = b;
    ...
    public Pixel(int[] c) {
        ...
        if (c == null) {
            ...
            // sets red and green to their values, and blue to 0 by default
            col[0] = c[0];
            col[1] = c[1];
            col[2] = 0;
        } else if (c.length == 1) {
            ...
            // sets red to its value, and blue and green to 0 by default
            col[0] = c[0];
            col[1] = 0;
            col[2] = 0;
        } else if (c.length == 0) {
            ...
            // set colors to their respective values
            col[0] = c[0];
            col[1] = c[1];
            col[2] = c[2];
        }
     ...
     */
    public int getRed() {
        return col[0]; // Implement this method
    }
     ...
     */
    public int getGreen() {
        return col[1]; // Implement this method
    }
     ...
     */
    public int getBlue() {
        return col[2]; // Implement this method
    }
    ...
    public int distance(Pixel px) {
        if (px == null) {
            ...
            return Math.abs(col[0] - px.col[0]) +
                    Math.abs(col[1] - px.col[1]) + Math.abs(col[2] - px.col[2]);
        }
    }
    ...
    public String toString() {
        return "(" + col[0] + ", " + col[1] + ", " + col[2] + ")"; // Implement this method
    }
    ...
    public boolean sameRGB(Pixel px) {
        return col[0] == px.col[0] && col[1] == px.col[1] && col[2] == px.col[2]; // Implement this
                                                                                  // method
    }
